            ...
            <div class="flex flex-wrap items-center gap-3">
                <div class="relative">
                    ...
                    <input
                        ...
                        class="pl-10 pr-4 py-2 text-sm rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-200 placeholder-gray-400 focus:ring-2 focus:border-transparent w-56"
                        style="--tw-ring-color: var(--color-primary)"
                    >
                </div>

                <select wire:model.live="categoryFilter" class="px-3 py-2 text-sm rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-200 focus:ring-2 focus:border-transparent" style="--tw-ring-color: var(--color-primary)">
                ...
                <input
                    ...
                    class="px-3 py-2 text-sm rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-200 focus:ring-2 focus:border-transparent"
                    style="--tw-ring-color: var(--color-primary)"
                >

                <select wire:model.live="typeFilter" class="px-3 py-2 text-sm rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-200 focus:ring-2 focus:border-transparent" style="--tw-ring-color: var(--color-primary)">
